...
func start(color, type):
	...
	# fix yellow text
	if TC.bot_color_code == Color(1, .99, .25) or TC.bot_color_code == Color(1, .84, .25):
		$Bot/Bot2Pt.set ("custom_colors/font_color", Color(0, 0, 0))
		$Bot/BotPat.set ("custom_colors/font_color", Color(0, 0, 0))
		$Bot/BotFg.set ("custom_colors/font_color", Color(0, 0, 0))
	if TC.top_color_code == Color(1, .99, .25) or TC.top_color_code == Color(1, .84, .25):
		$Top/Top2Pt.set ("custom_colors/font_color", Color(0, 0, 0))
		$Top/TopPat.set ("custom_colors/font_color", Color(0, 0, 0))
		$Top/TopFg.set ("custom_colors/font_color", Color(0, 0, 0))
...
func _on_BotPat_pressed():
	Main.get_node("MenuSelectSound").play()
