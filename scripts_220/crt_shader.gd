...
func start():
	...
	$CrtShader.set_material(shader_material)
	...
	$CrtShader/Tween.interpolate_property(shader_material,
						   "shader_param/tween_timer",
						   0, 999999, 999999,
						   Tween.TRANS_LINEAR, Tween.EASE_OUT)
	$CrtShader/Tween.start()


func end():
	$CrtShader/Tween.stop_all()
	$CrtShader.set_material(null)
	queue_free()
